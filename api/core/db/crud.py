...
def get_random_items(db: Session, n_recos=5) -> List[models.Item]:
...
def get_latest_items(db: Session, n_recos=5) -> List[models.Item]:
...
def get_frequently_bought_together_items(db: Session, item_id_seed: int, n_recos=5) -> List[models.Item]:
...
def get_item_based_collaborative_filtering_items(db: Session, item_id_seed: int, n_recos=5) -> List[models.Item]:
