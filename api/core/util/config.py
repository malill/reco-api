...
# reco-js
RECO_JS_COOKIE_ID = "reco-js-cookie-id"

# Recommendation types
COLLABORATIVE_FILTERING = "cf"
ITEM_BASED_COLLABORATIVE_FILTERING = COLLABORATIVE_FILTERING + "_ib"
USER_BASED_COLLABORATIVE_FILTERING = COLLABORATIVE_FILTERING + "_ub"
